;(function($){$.fn.feedbackBadge=function(options){this.config={css:{'position':'absolute','float':'right','display':'none','zIndex':'999'},'animate':false,'css3Safe':false,'float':'right'};$.extend(this.config,options);this.config.css.float=this.config.float;this.window=$(window);var self=this;if(this.config.css3Safe){this.badgeHeight=this.height();this.windowHeight=self.window.height();this.topDistance=~~(+(this.windowHeight-this.badgeHeight)/2);this.config.css.position='absolute';if(typeof(this.config.css.marginTop)=='undefined'){this.config.css.marginTop=this.getTopMiddleDistance(true);}
